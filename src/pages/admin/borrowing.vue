<template>
  <div class="container w-100 fd-c jc-c pt-10 pb-10 m-0-auto">
    <div class="w-60-L w-60-M w-100-S gradient-200 rad-fix-8 p-10-M p-10-S p-10-XS m-0-auto br-mcolor-400 br-1 brs-s">
      <Notification />
      <div class="w-100 pb-3 fd-r-S fd-c-XS pt-10 fs-6 f-white-200 fw-600">
        Total Liquidation Mode
      </div>
      <AmRadio :data="mode" />
      <div class="w-100 pb-8 fd-r-S fd-c-XS pt-10 fs-8 f-white-200 fw-600">
        Borrowing List
      </div>
